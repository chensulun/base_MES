        ...
        <el-col :span="18">
          <el-col :span="12">
            <el-form-item label="项目名称" prop="contractProjectName">
              <el-input
                readonly
                v-model="form.contractProjectName"
                placeholder="项目名称"
              />
            </el-form-item>
          </el-col>
          ...
          <el-col :span="24">
            <el-form-item label="客户名称" prop="contractCustomerName">
              <el-input
                readonly
                v-model="form.contractCustomerName"
                placeholder="请输入客户名称"
              />
            </el-form-item>
          </el-col>
          ...
          <el-col :span="24">
            <el-form-item label="支付条件" prop="contractTaxRate">
              <el-col
                :span="8"
                v-for="(item, index) in form.contractPaymentDataList"
              >
                <el-col :span="20">
                  <el-form-item
                    :label="'阶段' + (index + 1)"
            ...
            <div class="block">
              <el-timeline>
                ...
                >
                  ...
                  <p v-if="activity.hisData" v-for="item in activity.hisData">
  ...
  methods: {
    ...
    getContractInfo() {
      ...
      getContract(this.contractId).then((response) => {
        ...
        this.form.contractProductDataList = JSON.parse(
          this.form.contractProductData
        );
        this.form.contractPaymentDataList = JSON.parse(
          this.form.contractPaymentData
        );
