  ...
  <div class="app-container">
    ...
    >
      <contractHistoryForm
        ...
        v-if="'contract' == definitionKey"
      />
      <taskPlanHistoryForm
        :taskPlanId="businessKey"
        v-if="'taskPlan' == definitionKey"
      />
      <securityApproveHistoryForm
        :saId="businessKey"
        v-if="'securityApprove' == definitionKey"
      />
      <personnelRelations
        :contractId="businessKey"
        v-if="'securityApprove' == definitionKey"
...
import personnelRelations from "@/views/activiti/workflowFormdata/components/personnelRelations";
