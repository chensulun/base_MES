<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="授权代表" prop="supplierRepresentative">
        <el-input
          v-model="queryParams.supplierRepresentative"
          placeholder="请输入授权代表"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
    ...
    <el-table v-loading="loading" style="top: 30px" :data="supplierList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="编号" align="center" prop="supplierId" />
      <el-table-column label="供应商名称" align="center" prop="supplierName" />
      <el-table-column label="供应商简称" align="center" prop="supplierAbbreviation" />
      <el-table-column label="授权代表" align="center" prop="supplierRepresentative" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body :close-on-click-modal="false">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="授权代表" prop="supplierRepresentative">
          <el-input v-model="form.supplierRepresentative" placeholder="请输入授权代表" />
        </el-form-item>
        <el-form-item label="联系电话" prop="supplierPhone">
...
<script>
import { listSupplier, getSupplier, delSupplier, addSupplier, updateSupplier, exportSupplier } from "@/api/manage/supplier";
