      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['manage:material:edit']"
          >修改</el-button>
          <el-button
            size="mini"
            type="text"
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body :close-on-click-modal="false">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="上级类别" prop="parentId">
          <treeselect v-model="form.parentId" :options="materialOptions" :normalizer="normalizer" placeholder="请选择上级类别" />
        </el-form-item>
...
<script>
import { listMaterial, getMaterial, delMaterial, addMaterial, updateMaterial, exportMaterial } from "@/api/manage/material";
...
export default {
  ...
  methods: {
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      this.$confirm('是否确认删除原材编号为"' + row.materialId + '"的数据项?', "警告", {
