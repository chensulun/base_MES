  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
      ...
      <el-form-item label="选择项目" prop="tem">
        <el-select v-model="queryParams.projectName" style="width: 120px" @change="getList" placeholder="请选择">
          <el-option
            v-for="item in xiaoNameList"
            :key="item"
            :value="item"
            :label="item"
          />
...
<script>
  ...
  import {list, xiaoName, PBList} from "@/api/production/output";
  ...
  export default {
    ...
    methods: {
      ...
      getXiaoNameList(){
        ...
        xiaoName(this.queryParams).then(response => {
          this.xiaoNameList = response.list;
        });
      },
      /** 查询列表 */
      getList() {
